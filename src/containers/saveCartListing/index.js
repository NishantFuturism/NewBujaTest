          ...
          <div className="row" >
            <div className="col-12" >
              <div className="section-title product-spacing hm-11 mb-0">
                <h3 class={JSON.stringify(Dealofday)}>
                  {Dealofday && Dealofday.length > 0 && Dealofday[0].FiltersList && Dealofday[0].FiltersList.length > 0 && showSavedCart ? <span className='dealofday'>Saved Cart</span> : null
                    }
                </h3>
              </div>
              {Dealofday && Dealofday.length > 0 && Dealofday[0].FiltersList && Dealofday[0].FiltersList.length > 0 && showSavedCart &&

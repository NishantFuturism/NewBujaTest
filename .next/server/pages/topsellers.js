...
__webpack_require__.d(__webpack_exports__, {
  ...
  "default": () => (/* binding */ next_route_loaderpage_2Ftopsellers_preferredRegion_absolutePagePath_private_next_pages_2Ftopsellers_js_absoluteAppPath_private_next_pages_2F_app_js_absoluteDocumentPath_private_next_pages_2F_document_js_middlewareConfigBase64_e30_3D_),
  getServerSideProps: () => (/* binding */ next_route_loaderpage_2Ftopsellers_preferredRegion_absolutePagePath_private_next_pages_2Ftopsellers_js_absoluteAppPath_private_next_pages_2F_app_js_absoluteDocumentPath_private_next_pages_2F_document_js_middlewareConfigBase64_e30_3D_getServerSideProps),
...
// NAMESPACE OBJECT: ./src/pages/topsellers.js
var topsellers_namespaceObject = {};
__webpack_require__.r(topsellers_namespaceObject);
__webpack_require__.d(topsellers_namespaceObject, {
...
;// CONCATENATED MODULE: ./src/pages/topsellers.js
...
function dealoftheday({ topMenuData, footerPagesLinks, footerCategoryLinks, getTopsellersData, isLoading, sellerDetailsFromDomain }) {
    ...
    const [TopsellersProduct, setTopSellersProduct] = (0,external_react_.useState)(getTopsellersData || []);
    ...
    const changeFltr = (newFL)=>{
        ...
        setTopSellersProduct([]);
        if (newFL) {
            if (router && router.pathname !== undefined) {
                const url = router.pathname.split("/");
                homeServices/* default */.Z.getTopsellingdb(1, 100).then((response)=>{
                    setTopSellersProduct(response?.skuListingModels);
                    setloading(false);
                }).catch((error)=>{
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsxs)((head_default()), {
                children: [
                    /*#__PURE__*/ jsx_runtime.jsx("title", {
                        children: "Shop Top Sellers Products"
                    }),
                    /*#__PURE__*/ jsx_runtime.jsx("meta", {
                        name: "description",
                        content: `Shop Top Sellers Products`
                    })
                ]
            }),
                                        ...
                                        /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ jsx_runtime.jsx("div", {
                                                    ...
                                                    children: TopsellersProduct && !isFilterLoader && TopsellersProduct?.length === 0 ? /*#__PURE__*/ jsx_runtime.jsx("div", {
                                                        className: "col-md-12",
                                                        style: {
                                                            padding: "5%"
                                                        },
                                                    ...
                                                    }) : (TopsellersProduct || []).map((data)=>data.FiltersList.length !== 0 ? /*#__PURE__*/ jsx_runtime.jsx("div", {
...
async function getServerSideProps(context) {
    ...
    const getTopsellersData = await fetchTopSellingProductsData(sellerIdMain);
    console.log("getTopsellersData==", getTopsellersData);
    return {
        props: {
            topMenuData: topMenuData,
            footerPagesLinks: footerPagesLinks,
            footerCategoryLinks: footerCategoryLinks,
            getTopsellersData: getTopsellersData?.skuListingModels,
            isLoading: true,
            sellerDetailsFromDomain: sellerDetailsFromDomain
        }
    };
...
function fetchTopSellingProductsData(sellerIdMain) {
    const url = `${constants/* default */.ZP.urls.baseUrl}${constants/* default */.ZP.endPoints.topsellingai}ClientId=${homeServices/* ConstantsValues */.r.ClientId}&languageId=${homeServices/* ConstantsValues */.r.languageId}&currencyCode=${homeServices/* ConstantsValues */.r.currencyCode}&CustGUID=${homeServices/* ConstantsValues */.r.defaultCustGUID}&cartGuid=${homeServices/* ConstantsValues */.r.defaultCartGUID}&pincode=${homeServices/* ConstantsValues */.r.pincode}&sortby=MOD&IsgetAll=0&PageNumber=1&PageSize=100&SkuDetailid=0&sellerid=${sellerIdMain}`;
    return (0,apiServices/* httpRequest */.c)(url, "POST");
}

;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-route-loader/index.js?page=%2Ftopsellers&preferredRegion=&absolutePagePath=private-next-pages%2Ftopsellers.js&absoluteAppPath=private-next-pages%2F_app.js&absoluteDocumentPath=private-next-pages%2F_document.js&middlewareConfigBase64=e30%3D!
        ...
        /* harmony default export */ const next_route_loaderpage_2Ftopsellers_preferredRegion_absolutePagePath_private_next_pages_2Ftopsellers_js_absoluteAppPath_private_next_pages_2F_app_js_absoluteDocumentPath_private_next_pages_2F_document_js_middlewareConfigBase64_e30_3D_ = ((0,helpers/* hoist */.l)(topsellers_namespaceObject, "default"));

        // Re-export methods.
        const getStaticProps = (0,helpers/* hoist */.l)(topsellers_namespaceObject, "getStaticProps")
        const getStaticPaths = (0,helpers/* hoist */.l)(topsellers_namespaceObject, "getStaticPaths")
        const next_route_loaderpage_2Ftopsellers_preferredRegion_absolutePagePath_private_next_pages_2Ftopsellers_js_absoluteAppPath_private_next_pages_2F_app_js_absoluteDocumentPath_private_next_pages_2F_document_js_middlewareConfigBase64_e30_3D_getServerSideProps = (0,helpers/* hoist */.l)(topsellers_namespaceObject, "getServerSideProps")
        const config = (0,helpers/* hoist */.l)(topsellers_namespaceObject, "config")
        const reportWebVitals = (0,helpers/* hoist */.l)(topsellers_namespaceObject, "reportWebVitals")
        

        // Re-export legacy methods.
        const unstable_getStaticProps = (0,helpers/* hoist */.l)(topsellers_namespaceObject, "unstable_getStaticProps")
        const unstable_getStaticPaths = (0,helpers/* hoist */.l)(topsellers_namespaceObject, "unstable_getStaticPaths")
        const unstable_getStaticParams = (0,helpers/* hoist */.l)(topsellers_namespaceObject, "unstable_getStaticParams")
        const unstable_getServerProps = (0,helpers/* hoist */.l)(topsellers_namespaceObject, "unstable_getServerProps")
        const unstable_getServerSideProps = (0,helpers/* hoist */.l)(topsellers_namespaceObject, "unstable_getServerSideProps")

        // Create and export the route module that will be consumed.
        const options = {"definition":{"kind":"PAGES","page":"/topsellers","pathname":"/topsellers","bundlePath":"","filename":""}}
        const routeModule = new (module_default())({
          ...
          userland: topsellers_namespaceObject,
        })
...
var __webpack_exports__ = __webpack_require__.X(0, [6505,1664,8719,5675,3451,3190,4834,6920,8698,8659,7062,7895,6452,3497,8371,2447,3880], () => (__webpack_exec__(1117)));

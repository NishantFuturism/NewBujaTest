...
import { ADD_TO_CART, ADD_TO_CART_SUCCESS, NEXT_PAGE, NEXT_PAGE_SUCCESS, SHOPPING_CART_DETAILS_REORDER } from './constants';
...
function* NextBtnAPI(action) {
  try {
    const dealOfTheDayData = yield call(ReorderAPI.productReorder, action.pageNum, 9)
    // const cartAllData = yield call(mycartAPI.getCartCommon)
    // const shoppingcartDetails = yield call(mycartAPI.getShoppingcartDetails)

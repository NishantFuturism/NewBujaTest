...
export function ToppSellingOriginal(props) {
  ...
  const [topSelling, setTopSelling] = useState(props.topSellingProductsData && props.topSellingProductsData.skuListingModels || []);
  ...
  const [nextData, setNextData] = useState(props.topSellingProductsData && props.topSellingProductsData.skuListingModels || [])
  ...
  return (
    <>
      { topSelling !== undefined ?
        <div className="container-fluid homescreenselling crossSellingParent" style={{display: topSelling.length === 0 ? 'none' : 'block'}}>
          <div className="row" >

...
export function AddressForm(props) {
  ...
  const [usrPincode, setPincode] = useState('');
  const [usrPincodeError, setPincodeError] = useState(false);
  const [userCity, setUserCity] = useState();
  const [userCityError, setUserCityError] = useState(false);
  const [customerAddressList, setCustomerAddressList] = useState([])
  const [primaryAdreesId, setPrimaryAdreesId] = useState('')
        ...
        .then(addressresponse => {
          ...
          if (customerAddressList.length === 0 && (localStorage.getItem('UserFirstName') === '' || localStorage.getItem('UserFirstName') === null || localStorage.getItem('UserFirstName') === 'null' || localStorage.getItem('UserFirstName') === undefined || localStorage.getItem('UserFirstName') === 'undefined') && (localStorage.getItem('UserLastName') === '' || localStorage.getItem('UserLastName') === null || localStorage.getItem('UserLastName') === 'null' || localStorage.getItem('UserLastName') === undefined || localStorage.getItem('UserLastName') === 'undefined')) {
            ...
            if(!props.edit && primaryAdreesId){
              CheckoutAPI.getdefaultaddress(primaryAdreesId)
            }
            fetchaddress()
            props.cancelform()
  ...
  useEffect(() => {
    ...
    if (props && props.edit === true) {
      ...
      setMobno(props.editdata1.Mobile)
      setAddress1(props.editdata1.Address1)
      setAddress2(props.editdata1.Address2)
      setPincode(props.editdata1.ZipCode)
    }
  }
  }, [props])
  useEffect(() => {
        ...
        <div className="form-row mb-3">
          ...
          {props && props.edit ?
            <div className="form-group col-12 col-sm-12 col-md-6">
              ...
              <br />
              {typeof window !== 'undefined' && window.localStorage && (<Input
                type='text'
                id="ZipCode"
                className="form-control "
                required=""
                ...
                // value={localStorage.getItem('pincodevalue') && localStorage.getItem('pincodevalue') !== "" ? localStorage.getItem('pincodevalue') : usrPincode}
                value={props.isEdit ? props.editdata1.ZipCode : localStorage.getItem('pincodevalue') && localStorage.getItem('pincodevalue') !== "" ? localStorage.getItem('pincodevalue') : usrPincode}
                onChange={(e) => onChangePincode(e)}              // value=""
              ...
              />)}
              {usrPincodeError ? <span className="text text-danger field-validation-valid" style={{ textalign: 'left' }} >
        ...
        <div className="form-row mb-3">
          ...
          {props && props.edit ?
            <div className="form-group col-12 col-sm-12 col-md-6">
              ...
              value={props.isEdit ? props.editdata1.Address2 : props.Address !== '' ? props.Address : props.editdata1.Address2 }
            ...
            <div className="form-group col-12 col-sm-12 col-md-6">
              ...
              <br />
              {/* <b> */}
              {typeof window !== 'undefined' && window.localStorage ? localStorage.getItem('sublocalityvalue') && localStorage.getItem('sublocalityvalue') !== "" ?
                <Input
                  type="text"
                  id="Address2"
                  className="form-control "

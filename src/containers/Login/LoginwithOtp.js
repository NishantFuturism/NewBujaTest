      ...
      <div id="divloginwithotp" >
        ...
        <div className="form-group row align-items-center">
          <div style={{ width: '80%', display: 'block', position: 'relative', alignSelf: 'center' }}>
            ...
            <p>
              <Link href="dd;" id="sendloginUserWithOTP" style={{ color: 'gray', position: 'absolute', top: '7px', right: '26px', zIndex: '10px' }} >Send OTP</Link>
            </p>
        ...
        <div id="NotYetReceived" style={{ display: 'none' }}>
          <p align="center">
            Not received / expired your OTP? &nbsp; <Link href="dd;" style={{ color: 'dodgerblue', display: 'block', textAlign: 'center' }}><i className="fa fa-refresh"></i><span id="btnResendOTPNew">&nbsp;Resend OTP</span></Link>
          </p>
        </div>

                            ...
                            <div className="col-12 col-sm-12 col-md-12 col-lg-10">
                              <div className="tab-content dashboard-content" id="profile">
                                <div className="row" style={{ borderBottom: '1px solid #ebebeb', lineHeight: '24px', marginBottom: '20px', paddingBottom: '15px' }}>
                                  ...
                                  <div className="col-6 col-sm-6 col-md-6 col-lg-6 dashboardView" style={{ textAlign: 'right' }}>
                                    <input type="text"
                                            ...
                                            <tbody>
                                              {(orderlist || []).map(data =>
                                                <tr>
                                                  ...
                                                  <td id="orderamt">{data.Status === 'Awaiting Fullfillment' ? 'Awaiting Fulfillment' : data.Status}</td>

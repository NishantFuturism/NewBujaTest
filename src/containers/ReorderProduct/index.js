...
export function ReorderProduct({setRefreshCartData}) {
  ...
  useEffect(() => {//console.log('youarehere1')
  ...
  return (
    <>
      {Dealofday !== undefined ?
        <div className="container-fluid viewcartreorder" style={{display: Dealofday.length === 0 ? 'none' : 'block'} }>
          <div className="row" >
            <div className="col-12" >
              <div className="section-title product-spacing hm-11 mb-0" style={{ paddingLeft: "15px" }}>
                <h3>
                  {Dealofday && Dealofday.length === 0 ? null :
                    <span className='dealofday'>Reorder</span>}
                </h3>

                          ...
                          <div id="cart_accordion" className="mt-4" role="tablist">
                            <div className="card" style={{ marginBottom: '0px', borderBottom: '0px' }}>
                              <div className="card-header" role="tab" id="headingTax">
                                <h4 className="mb-0">
                                  <Link data-toggle="collapse" href="#OrderDetails" aria-expanded="true" aria-controls="OrderDetails" className="OrderDetails active">Order Details<i className="ion ion-ios-arrow-down"></i></Link>
                                </h4>
                              </div>
                              <div className="card-header" role="tab" id="headingTax">
                                <h4 className="mb-0">
                                        ...
                                        data.OrderItemDetails.map(dataitem =>
                                          <tr>
                                            <td>
                                              ...
                                              <Link href="/product/cucumber-greenkheera-harakakdi-hari/" target="_blank">

...
import homeServicesAPI from "../MainPage/api/homeServices";
// import { sendOtp, setInternalMsg, verifyOtpAction, registeruserdata } from './actions';
import { sendOtp, verifyOtpAction, registeruserdata, newUserRegistrationWithMobileOrEmail, userRegisterationUsingGmail, getCustIdByEmail } from './actions';
// import { loginWithPasswordAction } from '../Login/actions';
import reducer from './reducer';
import saga from './saga';
import './RegisterOriginal.css'
...
export function RegisterOrignal() {
  ...
  useEffect(() => {
    ...
    if (location && location.rediractFrom === '/login' && location.state.Uname !== null) {
      setUserName(location.state.Uname)
      console.log('location.state.Uname updated', typeof location.state.Uname)
    ...
    if (location && location.rediractFrom === '/login' && location.state.Uname === null) {
      setUserName('')
      console.log('location.state.Uname updated', location.state.Uname)
      setTimeout(() => {
        setenablechangeview(false)
        setShowOTPView(false)
      }, 2000)
                                            ...
                                            <div className="rgt_ipt_box">
                                              <div className="input-group">
                                                {/* <div className="input-group-prepend">
                                                 {false ?
                                                   <div className="input-group-text" id="registerBackIcon" style={{ cursor: 'pointer' }}>
                                                  ...
                                                  {/* <div className="btn-group">
                                                   {false ?
                                                     <button type="button" id="btnRegisterChangeUserName" className="btn btn-default input-group-btn"
                                                       style={{ backgroundColor: 'rgb(233, 236, 239)', border: '1px solid rgb(206, 212, 218)', }}
                                                  ...
                                                  {/* {enableDoneButton ?
                                                    <div className="btn-group">
                                                      <button type="button" id="btnRegisterChangeUserNameDone" className="btn btn-default input-group-btn"
                                                        ...
                                                        style={{ backgroundColor: '#e9ecef', border: '1px solid #ced4da', display: 'none' }}
                                                      >Done</button>
                                                    </div> : null} */}
                                                </div>
                                              </div>
                                            ...
                                            <form method="post" className="form-horizontal">
                                              <div>
                                                <p>
                                                  ...
                                                  {/* <GoogleLogin
                                                    // clientId="801814494387-hujju86qp10h7uurm880gt3ud4kecfut.apps.googleusercontent.com"
                                                    // redirectUri='/'
      ...
      <div style={{ textAlign: 'center', marginTop: '-30px' }} className="check_foot">
        ...
        <p align="center" style={{ paddingTop: '10px' }}>
          <small>
            ...
            <Link href="/delivery-policy" onClick={deliverypolicy} target="_blank" style={{ color: 'dodgerblue' }}>Delivery Policy</Link>&nbsp; &nbsp;

 ...
 *
 */
import { ADD_TO_CART, ADD_TO_COMPARE, ADD_TO_WISHLIST, CLOSE_MSG_BAR, DEFAULT_ACTION, NOTIFY_ME_REQUEST, QUICKVIEW, RECENT, REMOVE_FROM_CART, REMOVE_FROM_WISHLIST, SKUURL, PRODUCT_BRAND_LIST_FILTER,GET_TO_COMPARE } from './constants';
...
export function getcompare(SkuId, ip, compareflag) {

...
import PaymentAPI, { PaymentKey } from '../MainPage/api/payment';
import { getpaymentmethod, updateDeliveryslottime } from './actions';
          ...
          PaymentAPI.createOrderid(databody)
            .then(respo => {
              ...
              const options = {
                ...
                "prefill": {	
                  "name": name,	
                  "email": localStorage.getItem('Email') !== "null" && localStorage.getItem('Email') !== "" ? localStorage.getItem('Email') : null,	
                  "contact": localStorage.getItem('UserLastPhone') !== "null" && localStorage.getItem('UserLastPhone') !== "" ? localStorage.getItem('UserLastPhone') : null,	
                },
                "notes": {
                ...
                PaymentAPI.razorpayVerifysignature(databody)
                  .then(verify => {
                    ...
                    if (verify) {
                      ...
                      // setloading(true)
                      history.push('/product/checkout/order/paymentsuccess')
                    } else {

...
export function AddToCart(props) {
  ...
  const { cartRefresh, setCartRefresh } = useContext(Message_data);
  ...
  return (
    <>
      ...
      {openwarn && <Success msg={msg} close={close}></Success>}
      {
        ...
        //       <input type="text" onChange={(e) => QtyCoutFun(e)} className="validateQty addtocartqtytxt addtocartqty84562 addtocartqty2706" id={props.filteredata ? props.data.SkuDetailID : props.data.SkuId} defaultValue={QtyCout} maxLength="2" required="" />
        //     </span>
        //     <button className="btn-cart incdecaddtocart AddToCart2706"  style={{ width: '10' }} type="button"
        ...
        //   </div>)
          (
            <div className={props.skulisting ? "afterAddtocartButton" : "afterAddtocartonPDP"}
            onClick={() => AddtoCartfunction('inc', props.filteredata ? props.data.SkuDetailID : props.data.SkuId, filtered.SKUFilterPriceId, filtered.Capping)}
            >
            {/* <div className='afterAddtocartButton'> */}
                <div id='afterBtn' >            
                    {props.Reorder ? 
                    <a className='cartText'>Reorder</a>
                    :
                    <div className='cartIconwithAdd'>
                    <i className="lnr lnr-cart" id='cartIcon'></i>
       ...
       } */}
      {
        ...
        // (       
        //   <div className={props.skulisting === true ? 'beforeAddtocartButton':'beforeAddtocartOnPDP'}>
        //       <span className='minusIcon' onClick={() => IncrementDecrementCart('dec', props.filteredata ? props.data.SkuDetailID : props.data.SkuId, filtered.SKUFilterPriceId)}>
        //       {/* <i className="fa fa-minus"></i> */} -
        //       </span>
        //       <span className='countNumber'>
        //         {/* <input type='button' value={`${qty}`}/> */}
        //         {/* <span className='textNumber'> */}
        //           {qty}
        //           {/* </span> */}
        //       </span>
        //       <span className='plusIcon' onClick={() => IncrementDecrementCart('inc', props.filteredata ? props.data.SkuDetailID : props.data.SkuId, filtered.SKUFilterPriceId)}>
        //       {/* <i className="fa fa-plus"></i> */} +
        //       </span>
        //   </div>       
        // )

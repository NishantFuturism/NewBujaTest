...
__webpack_require__.d(__webpack_exports__, {
  ...
  "default": () => (/* binding */ next_route_loaderpage_2Fcancel_refund_and_exchange_preferredRegion_absolutePagePath_private_next_pages_2Fcancel_refund_and_exchange_js_absoluteAppPath_private_next_pages_2F_app_js_absoluteDocumentPath_private_next_pages_2F_document_js_middlewareConfigBase64_e30_3D_),
  getServerSideProps: () => (/* binding */ next_route_loaderpage_2Fcancel_refund_and_exchange_preferredRegion_absolutePagePath_private_next_pages_2Fcancel_refund_and_exchange_js_absoluteAppPath_private_next_pages_2F_app_js_absoluteDocumentPath_private_next_pages_2F_document_js_middlewareConfigBase64_e30_3D_getServerSideProps),
...
// NAMESPACE OBJECT: ./src/pages/cancel-refund-and-exchange.js
var cancel_refund_and_exchange_namespaceObject = {};
__webpack_require__.r(cancel_refund_and_exchange_namespaceObject);
__webpack_require__.d(cancel_refund_and_exchange_namespaceObject, {
  "default": () => (cancel_refund_and_exchange),
...
;// CONCATENATED MODULE: ./src/pages/cancel-refund-and-exchange.js
...
export default loadable(LazyComponent);*/ const ReturnAndExchange = ({ returnAndExchangePolicyData, sellerIDFromServer, sellerDetailsFromDomain })=>{
    const [Ftr, setFooter] = (0,external_react_.useState)(returnAndExchangePolicyData);
        ...
        children: [
            /*#__PURE__*/ (0,jsx_runtime.jsxs)((head_default()), {
                children: [
                    /*#__PURE__*/ jsx_runtime.jsx("title", {
                        children: returnAndExchangePolicyData?.PageTitle
                    }),
                    /*#__PURE__*/ jsx_runtime.jsx("meta", {
                        name: "description",
                        content: returnAndExchangePolicyData?.MetaDescription
                    }),
                    /*#__PURE__*/ jsx_runtime.jsx("meta", {
                        name: "keywords",
                        content: returnAndExchangePolicyData?.MetaKeyword
                    }),
                    /*#__PURE__*/ jsx_runtime.jsx("meta", {
                        property: "og:title",
                        content: returnAndExchangePolicyData?.PageTitle
                    }),
                    /*#__PURE__*/ jsx_runtime.jsx("meta", {
                        property: "og:url",
                        content: `/${returnAndExchangePolicyData?.PageUrl}`
                    }),
                    /*#__PURE__*/ jsx_runtime.jsx("meta", {
            ...
            /*#__PURE__*/ jsx_runtime.jsx("div", {
                ...
                children: /*#__PURE__*/ jsx_runtime.jsx(footerBreadCrumb/* default */.Z, {
                    activepage: "Return & Exchange Policy"
                })
            }),
            /*#__PURE__*/ jsx_runtime.jsx("div", {
...
async function getServerSideProps(context) {
    ...
    const returnAndExchangePolicyData = await getReturnAndExchangePolicyData(sellerIdMain);
    return {
        props: {
            returnAndExchangePolicyData: returnAndExchangePolicyData,
            sellerIDFromServer: sellerIdMain,
            sellerDetailsFromDomain: sellerDetailsFromDomain
        }
    };
}
function getReturnAndExchangePolicyData(sellerIdMain) {
    const url = `${constants/* default */.ZP.urls.baseUrl}${constants/* default */.ZP.endPoints.footer}pagename=cancel-refund-and-exchange&cid=1&languageId=2&sellerid=${sellerIdMain}`;
    return (0,apiServices/* httpRequest */.c)(url, "GET");
}
/* harmony default export */ const cancel_refund_and_exchange = (ReturnAndExchange);

;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-route-loader/index.js?page=%2Fcancel-refund-and-exchange&preferredRegion=&absolutePagePath=private-next-pages%2Fcancel-refund-and-exchange.js&absoluteAppPath=private-next-pages%2F_app.js&absoluteDocumentPath=private-next-pages%2F_document.js&middlewareConfigBase64=e30%3D!
        ...
        /* harmony default export */ const next_route_loaderpage_2Fcancel_refund_and_exchange_preferredRegion_absolutePagePath_private_next_pages_2Fcancel_refund_and_exchange_js_absoluteAppPath_private_next_pages_2F_app_js_absoluteDocumentPath_private_next_pages_2F_document_js_middlewareConfigBase64_e30_3D_ = ((0,helpers/* hoist */.l)(cancel_refund_and_exchange_namespaceObject, "default"));

        // Re-export methods.
        const getStaticProps = (0,helpers/* hoist */.l)(cancel_refund_and_exchange_namespaceObject, "getStaticProps")
        const getStaticPaths = (0,helpers/* hoist */.l)(cancel_refund_and_exchange_namespaceObject, "getStaticPaths")
        const next_route_loaderpage_2Fcancel_refund_and_exchange_preferredRegion_absolutePagePath_private_next_pages_2Fcancel_refund_and_exchange_js_absoluteAppPath_private_next_pages_2F_app_js_absoluteDocumentPath_private_next_pages_2F_document_js_middlewareConfigBase64_e30_3D_getServerSideProps = (0,helpers/* hoist */.l)(cancel_refund_and_exchange_namespaceObject, "getServerSideProps")
        const config = (0,helpers/* hoist */.l)(cancel_refund_and_exchange_namespaceObject, "config")
        const reportWebVitals = (0,helpers/* hoist */.l)(cancel_refund_and_exchange_namespaceObject, "reportWebVitals")
        

        // Re-export legacy methods.
        const unstable_getStaticProps = (0,helpers/* hoist */.l)(cancel_refund_and_exchange_namespaceObject, "unstable_getStaticProps")
        const unstable_getStaticPaths = (0,helpers/* hoist */.l)(cancel_refund_and_exchange_namespaceObject, "unstable_getStaticPaths")
        const unstable_getStaticParams = (0,helpers/* hoist */.l)(cancel_refund_and_exchange_namespaceObject, "unstable_getStaticParams")
        const unstable_getServerProps = (0,helpers/* hoist */.l)(cancel_refund_and_exchange_namespaceObject, "unstable_getServerProps")
        const unstable_getServerSideProps = (0,helpers/* hoist */.l)(cancel_refund_and_exchange_namespaceObject, "unstable_getServerSideProps")

        // Create and export the route module that will be consumed.
        const options = {"definition":{"kind":"PAGES","page":"/cancel-refund-and-exchange","pathname":"/cancel-refund-and-exchange","bundlePath":"","filename":""}}
        const routeModule = new (module_default())({
          ...
          userland: cancel_refund_and_exchange_namespaceObject,
        })
...
var __webpack_exports__ = __webpack_require__.X(0, [6505,1664,8719,5675,3451,3190,4834,6920,8698,8659,7062,7895,6452,3497,864], () => (__webpack_exec__(8734)));

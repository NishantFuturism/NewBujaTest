...
export default function NotFound() {
  return (
    <>
      ...
      // autoClose={50000}
      />
      <div className="login-wrapper pb-35" style={{textAlign:'-webkit-center', marginTop:'2rem'}}>
                ...
                <div className="row">
                  <div className="col-12 col-sm-12 col-md-12 col-lg-8 col-xl-6 offset-lg-2 offset-xl-3">
                    <div className="login-form error-page text-center">
                      ...
                      <a href="../"><button type='button' id='btnerror' className="btn-cart"><i className="fa fa-home"> </i> Go to Hompage</button></a></div>
                  </div>
                </div>
              </div>
            </main></div>

          ...
          <div className="col-lg-3 col-md-4 col-sm-6 abc" onLoad="defaultval()" data-overallcount="147" data-maxprice="1280.0000" data-minprice="5.0000">
            <div className="product-item mb-30 pr-block" data-skuid="83773" data-skucode="Onion/Kanda/Pyaj" data-skuurl="onionkandapyaj">
              <div className="product-thumb">
                <Link href="/product/onionkandapyaj" className="ajaxload">
              ...
              <div className="product-caption">
                ...
                <div className="product-name">
                  <h4><Link href="/product/onionkandapyaj"> Onion/Kanda/Pyaj</Link></h4>
                </div>
                ...
                <Link href="" title="Quick view" onClick="LoadProduct('onionkandapyaj')" data-url="onionkandapyaj" data-toggle="modal"><i className="lnr lnr-magnifier"></i></Link>

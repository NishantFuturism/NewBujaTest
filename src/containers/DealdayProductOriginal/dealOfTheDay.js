...
export function DealdayProductOriginal(props) {
  ...
  const [Dealofday, setgetDealofday] = useState(props.dealOfDayProducts && props.dealOfDayProducts.Data || []);
  ...
  return (
    <>
      { Dealofday && Dealofday !== undefined && Dealofday.length > 0 ?
        <div className={typeof window !== 'undefined' ? 'container-fluid homescreenproductsection crossSellingParent': "container-fluid homescreenproductsection dealofparent"} >
          <div className="row" >
            <div className={typeof window !== 'undefined' ? "col-12 crossSellingChild " : "col-12 dealofChild " }>

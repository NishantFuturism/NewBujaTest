                    ...
                    <div className="product-item pr-block" style={{ display: 'block' }} >
                      <div className="product-thumb">
                        ...
                        <div className="box-label">
                          ...
                          <div className="action-links">
                            ...
                            <Link href="" onClick={AddToCompare(this, 'TST0CB1')} title="Compare">
                          ...
                          <div className="action-links">
                            <Link onClick={AddToWishlist(this, 84562, 1)} href="" title="Add to Wishlist">
                              ...
                              </i></Link><Link href="" onClick={AddToCompare(this, 'TST0CB1')} title="Compare">
                              <i className="lnr lnr-sync"></i></Link>
                            <Link href="" title="Quick view" className="quickmodalview" onClick={LoadProduct('coffee-bean')} data-url="coffee-bean" data-toggle="modal">
                      ...
                      <div className="product-caption  product-caption-viewall">
                        ...
                        <div className="product-name">
                          <h4 ><Link href="/product/coffee-bean" style={{ display: 'block' }}>hsjhjh</Link></h4>
                        </div>

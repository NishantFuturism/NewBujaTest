...
function updatecart(IP, qty, skuId, SKUFilterPriceId, CouponCodeapply) {
  ...
  const url =
    `${Constants.urls.baseUrl}${Constants.endPoints.updateCart}IsRFQ=false&IsAssembled=false&City=pune&Country=India&IpAddress=${IP}&SessionId=${ConstantsValues.SessionId}&clientId=${ConstantsValues.ClientId}&couponCode=${CouponCodeapply}&cartGUID=${(localStorage.getItem('CartGUID') === null || localStorage.getItem('CartGUID') === undefined) ? ConstantsValues.defaultCartGUID : window.atob(localStorage.getItem('CartGUID'))}&CustGUID=${(localStorage.getItem('CustGUID') === null || localStorage.getItem('CustGUID') === undefined) ? ConstantsValues.defaultCustGUID : window.atob(localStorage.getItem('CustGUID'))}&qnt=${qty}&skuId=${skuId}&skufilterpriceid=${SKUFilterPriceId}&currencyCode=${ConstantsValues.currencyCode}&pincode=${pinvalue}&billingAddressId=&shippingMethodName=&shippingRate=&shippingAddressId=&sellerid=${localStorage.getItem('sellerID') === null || localStorage.getItem('sellerID') === undefined ? ConstantsValues.defaultSellerID : localStorage.getItem('sellerID')}`
...
function RemoveCartItem(skuId, SkuFilterPriceId) {
  const pinvalue = localStorage.getItem('pincodevalue') && localStorage.getItem('pincodevalue') !== '' ? localStorage.getItem('pincodevalue') : '411045';
  const url =
    `${Constants.urls.baseUrl}${Constants.endPoints.RemoveFromCart}IsRFQ=false&SkuFilterPriceId=${SkuFilterPriceId}&cartGUID=${(localStorage.getItem('CartGUID') === null || localStorage.getItem('CartGUID') === undefined) ? ConstantsValues.defaultCartGUID : window.atob(localStorage.getItem('CartGUID'))}&CustGUID=${(localStorage.getItem('CustGUID') === null || localStorage.getItem('CustGUID') === undefined) ? ConstantsValues.defaultCustGUID : window.atob(localStorage.getItem('CustGUID'))}&skuId=${skuId}&currencyCode=${ConstantsValues.currencyCode}&pincode=${pinvalue}&sellerid=${localStorage.getItem('sellerID') === null || localStorage.getItem('sellerID') === undefined ? ConstantsValues.defaultSellerID : localStorage.getItem('sellerID')}`
  return httpRequest(url, 'post');
}
function NotifyMeAPI(skuDetailId, skuPriceId) {
  const url =
    ...
    `${Constants.urls.baseUrl}${Constants.endPoints.notify}skuDetailId=${skuDetailId}&CustGUID=${(localStorage.getItem('CustGUID') === null || localStorage.getItem('CustGUID') === undefined) ? ConstantsValues.defaultCustGUID : window.atob(localStorage.getItem('CustGUID'))}&clientId=${ConstantsValues.ClientId}&skuPriceId=${skuPriceId}&sellerid=${localStorage.getItem('sellerID') || ConstantsValues.defaultSellerID}`
  return httpRequest(url, 'post');
}
function getCartCommon() {
  
  const pinvalue = localStorage.getItem('pincodevalue') && localStorage.getItem('pincodevalue') !== '' ? localStorage.getItem('pincodevalue') : ConstantsValues.pincode;
  const url =
    `${Constants.urls.baseUrl}${Constants.endPoints.getCartCommon}isUserAuthenticated=${!((localStorage.getItem('CustGUID') === null || localStorage.getItem('CustGUID') === undefined))}&addressid=${ConstantsValues.addressid}&cartId=${(localStorage.getItem('CartGUID') === null || localStorage.getItem('CartGUID') === undefined) ? ConstantsValues.defaultCartGUID : window.atob(localStorage.getItem('CartGUID'))}&clientId=${ConstantsValues.ClientId}&currencyName=${ConstantsValues.currencyCode}&currencySymbol=${ConstantsValues.currencyCode}&CustGUID=${(localStorage.getItem('CustGUID') === null || localStorage.getItem('CustGUID') === undefined) ? ConstantsValues.defaultCustGUID : window.atob(localStorage.getItem('CustGUID'))}&languageId=2&pincode=${pinvalue}&sellerid=${localStorage.getItem('sellerID') === null || localStorage.getItem('sellerID') === undefined ? ConstantsValues.defaultSellerID : localStorage.getItem('sellerID')}`
...
function getCouponCodeList() {
  const url =
    `${Constants.urls.baseUrl}${Constants.endPoints.couponCodeList}clientId=1&CustGUID=${(localStorage.getItem('CustGUID') === null || localStorage.getItem('CustGUID') === undefined) ? ConstantsValues.defaultCustGUID : window.atob(localStorage.getItem('CustGUID'))}&sellerid=${localStorage.getItem('sellerID') || ConstantsValues.defaultSellerID}`
  return httpRequest(url, 'get');
}
function getShoppingcartDetails(skuId, SkuFilterPriceId) {
  ...
  const url =
    `${Constants.urls.baseUrl}${Constants.endPoints.shoppingcartdetails}ShoppingCartGUID=${(localStorage.getItem('CartGUID') === null || localStorage.getItem('CartGUID') === undefined) ? ConstantsValues.defaultCartGUID : window.atob(localStorage.getItem('CartGUID'))}&CustGUID=${(localStorage.getItem('CustGUID') === null || localStorage.getItem('CustGUID') === undefined) ? ConstantsValues.defaultCustGUID : window.atob(localStorage.getItem('CustGUID'))}&skufilterpriceid=${SkuFilterPriceId}&SkuDetailId=${skuId}&sellerId=${localStorage.getItem('sellerID') === null || localStorage.getItem('sellerID') === undefined ? ConstantsValues.defaultSellerID : localStorage.getItem('sellerID')}`
  return httpRequest(url, 'get');
}
function getCancelCouponCode(CouponCode) {
  const url =
    `${Constants.urls.baseUrl}${Constants.endPoints.cancelCouponCode}CustGUID=${(localStorage.getItem('CustGUID') === null || localStorage.getItem('CustGUID') === undefined) ? ConstantsValues.defaultCustGUID : window.atob(localStorage.getItem('CustGUID'))}&cartId=${(localStorage.getItem('CartGUID') === null || localStorage.getItem('CartGUID') === undefined) ? ConstantsValues.defaultCartGUID : window.atob(localStorage.getItem('CartGUID'))}&clientId=1&CouponCode=${CouponCode}&sellerid=${localStorage.getItem('sellerID') || ConstantsValues.defaultSellerID}`;
  return httpRequest(url, 'get');
}
...
function removeInactiveFromCart() {
  const url =
    `${Constants.urls.baseUrl}${Constants.endPoints.GetRemoveInactiveFromCart}cartGUID=${(localStorage.getItem('CartGUID') === null || localStorage.getItem('CartGUID') === undefined) ? ConstantsValues.defaultCartGUID : window.atob(localStorage.getItem('CartGUID'))}&custGUID=${(localStorage.getItem('CustGUID') === null || localStorage.getItem('CustGUID') === undefined) ? ConstantsValues.defaultCustGUID : window.atob(localStorage.getItem('CustGUID'))}&sellerid=${localStorage.getItem('sellerID') === null || localStorage.getItem('sellerID') === undefined ? ConstantsValues.defaultSellerID : localStorage.getItem('sellerID')}`
  return httpRequest(url, 'POST');
}
function getCartnew() {
  const pinvalue = localStorage.getItem('pincodevalue') && localStorage.getItem('pincodevalue') !== '' ? localStorage.getItem('pincodevalue') : ConstantsValues.pincode;

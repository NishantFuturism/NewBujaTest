...
import ReorderAPI from '../../../containers/MainPage/api/Reorder';
import MyAccountSideNav from '../../../containers/MyAccount/MyAccountSideNav';
import Footer from '../../../components/Footer/footer'
// import history from '../../utils/history';
import { useRouter } from 'next/router';

import Loadreorder from '../../../containers/MyAccount/Loadreorder';
                          ...
                          <div className="row">
                            ...
                            <div className="col-12 col-sm-12 col-md-12 col-lg-10" id="my-account-reorder">
                              <div className="section-title" id="shoppicartheading">
                                ...
                                <h3>Reorder <span>({`${reorderlist && reorderlist.GetSku && reorderlist.GetSku.length > 0 ? (reorderlist.GetSku.length) : 0}`})</span></h3>
                              </div>
                              <div id="last_purchaseddiv">
                                ...
                                <table className="table table-bordered reorderonmob" id="last_Purchased">                           
                                    {reorderlist && reorderlist.GetSku && reorderlist.GetSku.length > 0 ? <thead>
                                      <tr>
                                        <th>Product Image</th>
                                        <th
                                        ...
                                        <th style={{ textAlign: 'center' }} id="datecolumn">Purchased Date
                                    ...
                                    <>
                                      {showEmptyOrder && (<div id="last_purchaseddiv">
                              ...
                              <div id="last_purchaseddiv">
                                <div className="col-md-12 p-0">
                                  <div className="cart-button-wrapper d-flex justify-content-between mt-4 mobilereorderbutton">
                                    <Link href="/" className="btn btn-secondary" style={{ backgroundColor: '#000', color: '#ffffff' }}>Continue Shopping</Link>
                                    <Link id="checkouthide" href="/cart" className="btn btn-secondary dark align-self-end" style={{ backgroundColor: '#000', color: '#ffffff' }}>Go to Cart</Link>
                                  </div>
                                </div>
                              </div>
                            </div>

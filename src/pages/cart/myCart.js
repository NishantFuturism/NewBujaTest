...
export function ViewCart() {
  ...
  useEffect(()=>{
    if(custGuidL){
      mycartAPI.getCouponCodeList(1, custGuidL)
      .then((couponListres)=>{
        setcouponList(couponListres.couponList)
      })
    }
  },[custGuidL])
  useEffect(() => {
                            ...
                            <div className="check_foot">
                              ...
                              <p align="center" style={{ paddingTop: '10px' }}>
                                <small>
                                  ...
                                  {/*<a href onClick={deliverypolicy} to="/delivery-policy" style={{ color: 'dodgerblue', cursor: 'pointer' }}>Delivery Policy</a>&nbsp;&nbsp;*/}

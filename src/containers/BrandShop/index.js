...
export function BrandsProduct() {
  ...
  useEffect(() => {
    if (nextData !== undefined && nextData.shoppingcartDetails.length !== 0) {
     
      setShppingcart(nextData.shoppingcartDetails)
    }
  }, [nextData,]);
  const Gallery = () => (
    <Carousel
                  ...
                  <div className="owl-stage-outer">
                    <div className="owl-stage"
                      ...
                      <div className=" active" >
                        ...
                        <LoadProducts data={mapdata} index={i} shppingcart={shppingcart} />
                      </div>
                    </div>
                  </div>
                </div>

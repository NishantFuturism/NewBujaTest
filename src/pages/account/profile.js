...
import { otpsend, updateprofile, sendUpdateProfileEmail } from '../../containers/MyAccount/actions';
import reducer from '../../containers/MyAccount/reducer';
import saga from '../../containers/MyAccount/saga';
import '../../containers/MyAccount/checkbox.css';
...
import ProfileAPI from '../../containers/MainPage/api/profile';
...
export function Profile() {
  ...
  const onSubmit = (data) => {
    ...
    //console.log('userTitileValue', userTitileValue)
    // console.log('mobilevalue', typeof mobilevalue)
    // console.log('data--', data)
    console.log('data--', firstLoadCheck, disablemobile, disableEmail)
    ...
    if (firstName === '' || firstName === null) {
      ...
      //console.log('Emailmobile===', emailvalue, mobilevalue, disableEmail, disablemobile)
    ...
    else if (firstLoadCheck > 0 && (emailvalue === null || emailvalue === '') && disableEmail === false) {
     // console.log('emailfirstLoadCheck--',firstLoadCheck, disableEmail, emailvalue)
      setEmailValueError(true)
      // dispatch(updateprofile(firstName, LastName, CompanyName, emailvalue, mobilevalue, true))
      ...
      // alert('110')
      if(disableEmail === true && disablemobile === true){
    ...
    //  console.log('mobilefirstLoadCheck--',firstLoadCheck, disablemobile, mobilevalue)
      setMobileValueError(true)
      // dispatch(updateprofile(firstName, LastName, CompanyName, emailvalue, mobilevalue, true))
      // localStorageDataUpdated(firstName, LastName, mobilevalue, emailvalue)
    }
  ...
  useEffect(() => {
   ...
   // console.log(`47--${window.atob(localStorage.getItem('CustGUID'))}`)
    ...
    invalidotp = localStorage.getItem('invalidOTP')
                          ...
                          <div className="row">
                            ...
                            <div className="col-12 col-sm-12 col-md-12 col-lg-10">
                              <div className="tab-content dashboard-content" id="profile">
                                <h3>Profile </h3>
                                {isMount && (<div className="login-form">
                                  <form id="frm_update_profile"
                                    ...
                                    verified="" name="PhoneOTPGUID" /> */}
                                        ...
                                        <input id="txtPhone" className="form-control" disabled={disablemobile}
                                          ...
                                          maxLength="10"
                                          placeholder="Mobile Number (10 digit)" type="number" pattern="^(\+)?(1\s*[-\/\.]?)?(\((\d{3})\)|(\d{3}))\s*[-\/\.]?\s*(\d{3})\s*[-\/\.]?\s*(\d{4})\s*(([xX]|[eE][xX][tT])\.?\s*(\d+))*$" name="Phone" />
                                        {/* <input type="hidden"
                                    defaultValue={phone}
                                    id="Phone" name="Phone" /> */}
                                  ...
                                  /> */}
                                    ...
                                    <div className="form-check row p-0 mt-0">
                                      <div className="col-12 col-sm-12 col-md-8 offset-md-4 col-lg-6 offset-lg-3">
                                        <label className="myprof d-inline-block">Receive offers  </label>
                                        <span className="myProfilecheckbox">
                                        <input
                                        className='checkmarkmyprof'
                                            type="checkbox"
                                            checked={receivedOfferCheckboxValue}
                                            onChange={(e) => receivedOfferOnChange(e)} />
                                          <span className="checkmarkProfile"></span>
                                        </span>                                       
                                ...
                                <span className="checkmark"></span>
                                    ...
                                    <div className="form-check row p-0">
                                      <div className="col-12 col-sm-12 col-md-8 offset-md-4 col-lg-6 offset-lg-3">
                                        ...
                                        <Link href="/account/dashboard" className="btn btn-secondary"><i className="fa fa-times"></i> Cancel</Link>
                                      </div>
                                    </div>

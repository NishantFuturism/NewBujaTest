                            ...
                            <div className="col-12 col-sm-12 col-md-12 col-lg-10">
                              <div className="tab-content dashboard-content">
                                <div id="dashboard" className="tab-pane fade show active">
                                  <h3>Dashboard </h3>
                                  {isMount && (<div className="row">
                                    <div className="col-sm-12 col-md-6 col-lg-6 profile" id="profilesummary">
                                      <div className="card border-primry mb-3">
                                        <div className="card-body text-primary dash-height" style={{ height: '323px' }}>
                                          ...
                                          <div className="card-text"><span className="lnr lnr-user" aria-hidden="true"></span>&nbsp;&nbsp;
                                          {userdetail.FirstName}  {userdetail.LastName}</div>
                                          <div className="card-text "><i className="fa fa-phone"></i>&nbsp; {username}</div>
                                          <div className="card-text">Receive Offers :&nbsp;{userdetail.ReceiveOffers ? 'on' : 'off'}</div>
                                        </div>

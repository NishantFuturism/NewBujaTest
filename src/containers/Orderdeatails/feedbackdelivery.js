        ...
        <div className="modal-dialog modal-mg">
          <div className="modal-content ">
            ...
            <div className="modal-body">
              ...
              <div>
                <label>Order delivered on {day}, {dateConverter(OrderItemDetails[0]?.DeliveryDate)}</label>
              </div>
            ...
            <div className="modal-footer">
              ...
              <button type="button" className="btn btn-danger" id="cancelfeedback" data-dismiss="modal" onClick={() => setClosebar(false)}><b>Cancel</b></button><br />
            </div>
          </div>
        </div>
      </div> : null}

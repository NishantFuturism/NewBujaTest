  ...
  return (
    <div key={props.index} className="product-item pr-block" ref={listRef}>
      <div className="product-thumb">
        <Link href="/product/coffee-bean" className="ajaxload">
        ...
        <div className="box-label">
          ...
          <div className="action-links">
            ...
            <Link href={""} onClick={AddToCompare()} title="Compare"><i className="lnr lnr-sync" /> </Link>
            <Link href={""} title="Quick view" className="LoadProduct'coffee-bean') quickmodalview" data-url="coffee-bean" data-toggle="modal" >
              <i className="lnr lnr-magnifier" />
            </Link>
          </div>
          <div className="action-links">
            <Link href="" onClick={() => AddToWishlist(props.data.SkuId, filtered.SKUFilterPriceId)} title="Add to Wishlist" ><i className="lnr lnr-heart" /></Link>
            <Link href={""} onClick={AddToCompare()} title="Compare"><i className="lnr lnr-sync" /> </Link>
            <Link href={""} title="Quick view" className="quickmodalview" onClick={LoadProduct('coffee-bean')} ata-url="coffee-bean" data-toggle="modal" ><i className="lnr lnr-magnifier" /></Link>
          </div>
        </div>
      </div>
      <div className="product-caption  product-caption-viewall">
        ...
        <div className="product-name">
          <h4>
            <Link href="/product/coffee-bean">{props.data.Name}</Link>
          </h4>
        </div>

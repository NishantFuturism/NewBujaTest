...
__webpack_require__.d(__webpack_exports__, {
  ...
  "default": () => (/* binding */ next_route_loaderpage_2Ftoptrending_preferredRegion_absolutePagePath_private_next_pages_2Ftoptrending_js_absoluteAppPath_private_next_pages_2F_app_js_absoluteDocumentPath_private_next_pages_2F_document_js_middlewareConfigBase64_e30_3D_),
  getServerSideProps: () => (/* binding */ next_route_loaderpage_2Ftoptrending_preferredRegion_absolutePagePath_private_next_pages_2Ftoptrending_js_absoluteAppPath_private_next_pages_2F_app_js_absoluteDocumentPath_private_next_pages_2F_document_js_middlewareConfigBase64_e30_3D_getServerSideProps),
...
// NAMESPACE OBJECT: ./src/pages/toptrending.js
var toptrending_namespaceObject = {};
__webpack_require__.r(toptrending_namespaceObject);
__webpack_require__.d(toptrending_namespaceObject, {
...
;// CONCATENATED MODULE: ./src/pages/toptrending.js
...
function dealoftheday({ topMenuData, footerPagesLinks, footerCategoryLinks, gettopTrendingData, isLoading, sellerDetailsFromDomain }) {
    ...
    const [ToptrendingProduct, setToptrendingProduct] = (0,external_react_.useState)(gettopTrendingData || []);
    ...
    const changeFltr = (newFL)=>{
        ...
        if (newFL) {
            if (router && router.pathname !== undefined) {
                ...
                homeServices/* default */.Z.getTopTrendingProductList(1, 100).then((response)=>{
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsxs)((head_default()), {
                children: [
                    /*#__PURE__*/ jsx_runtime.jsx("title", {
                        children: "Shop Top Trending Products"
                    }),
                    /*#__PURE__*/ jsx_runtime.jsx("meta", {
                        name: "description",
                        content: `Shop Top Trending Products`
                    })
                ]
            }),
                                        ...
                                        /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ jsx_runtime.jsx("div", {
                                                    ...
                                                    children: ToptrendingProduct && !isFilterLoader && ToptrendingProduct?.length === 0 ? /*#__PURE__*/ jsx_runtime.jsx("div", {
                                                        className: "col-md-12",
                                                        style: {
                                                            padding: "5%"
                                                        },
                                                    ...
                                                    }) : (ToptrendingProduct || []).map((data)=>data.FiltersList.length !== 0 ? /*#__PURE__*/ jsx_runtime.jsx("div", {
...
function fetchTopTrendingProductsData(sellerIdMain) {
    const url = `${constants/* default */.ZP.urls.baseUrl}${constants/* default */.ZP.endPoints.GetTopTrendingProductList}pincode=${homeServices/* ConstantsValues */.r.pincode}&LanguageId=${homeServices/* ConstantsValues */.r.languageId}&CartGUID=${homeServices/* ConstantsValues */.r.defaultCartGUID}&CustGUID=${homeServices/* ConstantsValues */.r.defaultCustGUID}&clientId=${homeServices/* ConstantsValues */.r.ClientId}&currencyCode=${homeServices/* ConstantsValues */.r.currencyCode}&IsgetAll=0&PageNumber=1&PageSize=100&skudetailid=0&sellerid=${sellerIdMain}`;
    return (0,apiServices/* httpRequest */.c)(url, "GET");
}

;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-route-loader/index.js?page=%2Ftoptrending&preferredRegion=&absolutePagePath=private-next-pages%2Ftoptrending.js&absoluteAppPath=private-next-pages%2F_app.js&absoluteDocumentPath=private-next-pages%2F_document.js&middlewareConfigBase64=e30%3D!
        ...
        /* harmony default export */ const next_route_loaderpage_2Ftoptrending_preferredRegion_absolutePagePath_private_next_pages_2Ftoptrending_js_absoluteAppPath_private_next_pages_2F_app_js_absoluteDocumentPath_private_next_pages_2F_document_js_middlewareConfigBase64_e30_3D_ = ((0,helpers/* hoist */.l)(toptrending_namespaceObject, "default"));

        // Re-export methods.
        const getStaticProps = (0,helpers/* hoist */.l)(toptrending_namespaceObject, "getStaticProps")
        const getStaticPaths = (0,helpers/* hoist */.l)(toptrending_namespaceObject, "getStaticPaths")
        const next_route_loaderpage_2Ftoptrending_preferredRegion_absolutePagePath_private_next_pages_2Ftoptrending_js_absoluteAppPath_private_next_pages_2F_app_js_absoluteDocumentPath_private_next_pages_2F_document_js_middlewareConfigBase64_e30_3D_getServerSideProps = (0,helpers/* hoist */.l)(toptrending_namespaceObject, "getServerSideProps")
        const config = (0,helpers/* hoist */.l)(toptrending_namespaceObject, "config")
        const reportWebVitals = (0,helpers/* hoist */.l)(toptrending_namespaceObject, "reportWebVitals")
        

        // Re-export legacy methods.
        const unstable_getStaticProps = (0,helpers/* hoist */.l)(toptrending_namespaceObject, "unstable_getStaticProps")
        const unstable_getStaticPaths = (0,helpers/* hoist */.l)(toptrending_namespaceObject, "unstable_getStaticPaths")
        const unstable_getStaticParams = (0,helpers/* hoist */.l)(toptrending_namespaceObject, "unstable_getStaticParams")
        const unstable_getServerProps = (0,helpers/* hoist */.l)(toptrending_namespaceObject, "unstable_getServerProps")
        const unstable_getServerSideProps = (0,helpers/* hoist */.l)(toptrending_namespaceObject, "unstable_getServerSideProps")

        // Create and export the route module that will be consumed.
        const options = {"definition":{"kind":"PAGES","page":"/toptrending","pathname":"/toptrending","bundlePath":"","filename":""}}
        const routeModule = new (module_default())({
          ...
          userland: toptrending_namespaceObject,
        })
...
var __webpack_exports__ = __webpack_require__.X(0, [6505,1664,8719,5675,3451,3190,4834,6920,8698,8659,7062,7895,6452,3497,8371,2447,3880], () => (__webpack_exec__(7060)));

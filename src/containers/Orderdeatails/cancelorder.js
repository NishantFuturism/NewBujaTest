      ...
      <Modal show animation style={{ transition: 'all 0.55s ease-in -out' }}>
        ...
        <div className="modal-body">
            ...
            <select
              ...
              {reason7 && reason7.map(data =>
                <option
                  ...
                  value={data.OrderReasonId} {...register('reason', { required: true })}>{data.Reasons} </option>)}
            </select>
            {errors.reason ?
          ...
          <div className="mb-10 form-group">
            ...
            {errors.comment &&
              <span className="text text-danger field-validation-error" >Please enter comment </span> }
          </div>

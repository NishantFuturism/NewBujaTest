                                    ...
                                    <div className='row'>
                                      <div className="col-12 col-sm-12 col-md-12 col-lg-12" id="hidebillingsection">
                                        ...
                                        <div className='checkout-form'>
                                          ...
                                          <AddressList atosuggestdadta={atosuggestdadta} hideChooseDeliveryTimeSlot={(e) => hideChooseDeliveryTimeSlot(e)} />
                                          {
                ...
                <div style={{ textAlign: 'center' }} className="check_foot">
                  ...
                  <p align="center" style={{ paddingTop: '10px' }}>
                    <small>
                      ...
                      <Link onClick={deliverypolicy} href="/delivery-policy" target="_blank" style={{ color: 'dodgerblue' }}>Delivery Policy</Link>&nbsp; &nbsp;

...
export function NewArrivalProduct(props) {
  ...
  const [Dealofday, setgetDealofday] = useState(props.newArrivalProductsData && props.newArrivalProductsData.Data || []);
  ...
  return (
    <>
      {Dealofday !== undefined ?
        <div className="container-fluid newArrivals" style={{display: Dealofday.length === 0 ? 'none' : 'block'}}>
          <div className="row" >

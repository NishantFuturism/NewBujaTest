...
export function TopTrendingProduct(props) {
  ...
  const [Dealofday, setgetDealofday] = useState(props.topTrendingProductsData && props.topTrendingProductsData.skuListingModels || []);
                  ...
                  <div className="owl-stage-outer">
                    <div className="owl-stage"
                      ...
                      <div className=" active" >
                        ...
                        <LoadProducts source="toptrend" data={mapdata} shppingcart={shppingcart} index={i} skulisting />
                      </div>
                    </div>
                  </div>
                </div>
  ...
  return (
    <>
      {Dealofday !== undefined ?
        <div className="container-fluid treandingproduct crossSellingParent"   style={{display: Dealofday.length === 0 ? 'none' : 'block'}}>
          <div className="row" >
            <div className="col-12 crossSellingChild" >
              <div className="section-title product-spacing hm-11 mb-0" style={{ paddingLeft: "15px" }}>
                {Dealofday.length > 0 && <h3>
